...
import { Ao as Scene, Br as LinearMipmapLinearFilter, Bt as Data3DTexture, Da as RGBADepthPacking, Gs as Vector4, Ho as Sphere, Hr as LinearSRGBColorSpace, Ht as DataTexture, Ir as LinearFilter, Is as UnsignedInt248Type, J as BufferAttribute, L as BasicDepthPacking, Oa as RGBAFormat, Oo as SRGBColorSpace, Ps as UnsignedByteType, Qr as Material, Qs as WebGLRenderTarget, Rs as UnsignedIntType, Si as NearestFilter, Sn as FloatType, Us as Vector2, Vn as HalfFloatType, Ws as Vector3, Xt as DepthTexture, Y as BufferGeometry, Yt as DepthStencilFormat, bo as RepeatWrapping, ci as MeshDepthMaterial, co as RGFormat, ct as Color, ea as OrthographicCamera, fi as MeshNormalMaterial, gn as EventDispatcher, ia as PerspectiveCamera, ii as Matrix4, jn as GLSL3, jo as ShaderMaterial, js as Uniform, mo as RedFormat, ms as TextureLoader, oi as Mesh, ot as ClampToEdgeWrapping, ps as Texture$1, qr as LoadingManager, tt as CanvasTexture, xn as Float32BufferAttribute } from "./three.module-CwO0auyC.js";
import { D as useLoader, c as applyProps, g as extend, k as useThree, p as createPortal, w as useFrame } from "./react-three-fiber.esm-BWmolasv.js";
import { t as easing } from "./maath.esm-BMELANtA.js";
...
var ToneMappingEffect = class extends Effect {
	...
	*/
	...
	set mode(value) {
		...
		const cineonToneMapping = "186".replace(/\D+/g, "") >= 168 ? "CineonToneMapping(texel)" : "OptimizedCineonToneMapping(texel)";
		this.defines.clear();
...
var threeRevision = Number("186".replace(/\D+/g, ""));

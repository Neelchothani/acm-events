...
export const ScrollHint = () => {
  ...
  return (
    <div 
      className={`fixed bottom-8 left-1/2 -translate-x-1/2 lg:translate-x-0 lg:left-32 z-40 pointer-events-none transition-opacity duration-1000 ${isVisible ? 'opacity-100' : 'opacity-0'}`}
    >
